                ...
                else
                {
                    ...
                    switch (carrodepaseo.cambio)
                    {
                        ...
                        case 2:
                            ...
                            carrodepaseo.distanciarecorrida = carrodepaseo.distanciarecorrida - 27;
                            if (carrodepaseo.distanciarecorrida >= 50)
                            {
                                carrodepaseo.galones = carrodepaseo.galones - 3;
                                if (carrodepaseo.galones == 0)
                        ...
                        case 3:
                            ...
                            carrodepaseo.distanciarecorrida = carrodepaseo.distanciarecorrida - 30;
                            if (carrodepaseo.distanciarecorrida >= 50)
                            {
                                carrodepaseo.galones = carrodepaseo.galones - 3;
                                if (carrodepaseo.galones == 0)
                            ...
                            break;
                        case 4:
                            carrodepaseo.velocidad = carrodepaseo.velocidad - 45;
                            carrodepaseo.distanciarecorrida = carrodepaseo.distanciarecorrida - 50;
                            if (carrodepaseo.distanciarecorrida >= 50)
                            {
                                carrodepaseo.galones = carrodepaseo.galones - 3;
